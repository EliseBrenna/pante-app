                ...
                <div className="helpContainer">
                    <div className="supportContainer">
                        ...
                        <div className="support">
                            <h3>Overfør til konto</h3>
                        </div>
                {
                    !messagePop? (
                        <div className="supportOptions">
                            <p onClick={this.handleWithdraw.bind(this)}>Overfør saldo ></p>
                            <p>Dine kontoer ></p>
                            <p>Legg til konto ></p>
                        </div>
                        ...
                        <div className="withdrawPop">
                            <div className="withdrawBtnContainer">
                                <button className="exitBtn" onClick={() => this.handleMessageExit()}>x</button>
                            </div>
                            {withdrawMessage && <h4>{withdrawMessage}</h4>}
                        </div>
                    )
                }
